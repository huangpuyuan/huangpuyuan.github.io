...
date: 2019-08-30
category: "统计学"
summary: "dataquest上的一篇文章：Math in Data Science 列举了在数据科学中一些需要掌握的常用基本数学模型。 朴素贝叶斯、线性回归、Logistic回归、神经网络、K均值聚类、决策树 1 Naïve Ba"
---
dataquest上的一篇文章：[Math in Data Science](https://www.dataquest.io/blog/math-in-data-science/) 列举了在数据科学中一些需要掌握的常用基本数学模型。
...
![neural_networks](/images/blog/neural_networks.jpg)
...
![img](/images/blog/machine_learning_2x.png)
